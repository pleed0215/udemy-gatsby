...
export type SiteSiteMetadata = {
  ...
  context?: Maybe<SiteSiteMetadataContext>;
};

export type SiteSiteMetadataContext = {
  siteData?: Maybe<Scalars['String']>;
};
...
export type SiteSiteMetadataFilterInput = {
  ...
  context?: InputMaybe<SiteSiteMetadataContextFilterInput>;
};

export type SiteSiteMetadataContextFilterInput = {
  siteData?: InputMaybe<StringQueryOperatorInput>;
};
...
export type SiteFieldsEnum =
  ...
  | 'siteMetadata___context___siteData'
  | 'port'
  | 'host'
  | 'id'
  | 'parent___id'
...
export type PostConnectionMaxArgs = {
  field: PostFieldsEnum;
};


export type PostConnectionMinArgs = {
  field: PostFieldsEnum;
};


export type PostConnectionSumArgs = {
  field: PostFieldsEnum;
};
...
export type PostGroupConnectionDistinctArgs = {
  field: PostFieldsEnum;
};


export type PostGroupConnectionMaxArgs = {
  field: PostFieldsEnum;
};


export type PostGroupConnectionMinArgs = {
  field: PostFieldsEnum;
};


export type PostGroupConnectionSumArgs = {
  field: PostFieldsEnum;
};


export type PostGroupConnectionGroupArgs = {
  skip?: InputMaybe<Scalars['Int']>;
  limit?: InputMaybe<Scalars['Int']>;
  field: PostFieldsEnum;
};
...
export type PostSortInput = {
  fields?: InputMaybe<Array<InputMaybe<PostFieldsEnum>>>;
  order?: InputMaybe<Array<InputMaybe<SortOrderEnum>>>;
};
...
export type Unnamed_1_Query = { site?: { siteMetadata?: { title?: string | null | undefined, siteUrl?: string | null | undefined, context?: { siteData?: string | null | undefined } | null | undefined } | null | undefined } | null | undefined };

export type Unnamed_2_QueryVariables = Exact<{ [key: string]: never; }>;


export type Unnamed_2_Query = { allMarkdownRemark: { totalCount: number, nodes: Array<{ id: string, excerpt?: string | null | undefined, frontmatter?: { title?: string | null | undefined, subtitle?: string | null | undefined, date?: any | null | undefined } | null | undefined }> } };

export type AllPostQueryVariables = Exact<{ [key: string]: never; }>;


export type AllPostQuery = { allPost: { edges: Array<{ node: { id: string, title?: string | null | undefined, body?: string | null | undefined } }> } };
